    ...
    return (
        <section className="flex flex-col gap-y-4 mx-2 pb-4">
            ...
            <p className="text-xs lg:text-sm text-slate-900 text-justify leading-5">
                ...
                توانند با به اشتراک گذاشتن احساسات لحظه ای خود، به اجتماع و خود کمک کنند. حس همدردی، عشق، تلاش،
                شادی، غم و ... می تواند با دیگران تقسیم شود. دیگران را شاد کند، انگیزه، غم و درد آنها را تسکین دهد.
            </p>
